...
class Args:
    ...
    train_file: str = "/data/data/hancom/train.txt"
    validation_file: str = "/data/data/hancom/dev.txt"
    tokenizer_name: str = "/data/dani/hannlp/tokenizer-model/vocab.txt"
    do_train: bool = True
    do_eval: bool = True
    output_dir: str = "./test-mlm-hancom2"
...
def main():
    ...
    if model_args.tokenizer_name:
        tokenizer = BertTokenizer.from_pretrained(model_args.tokenizer_name, **tokenizer_kwargs,\
            model_max_length=data_args.max_seq_length, do_lower_case=True)
    elif model_args.model_name_or_path:
